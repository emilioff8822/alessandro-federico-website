...
### [PLACEHOLDER — Da completare con materiali del cliente]

| Elemento | Valore |
|---|---|
| **Nome completo** | Dr. Alessandro Federico |
| **Titolo professionale** | Dermatologo · Medicina Estetica |
| **Accent primario** | `[DA DEFINIRE]` |
| **Accent scuro (Navbar/Footer)** | `[DA DEFINIRE]` |
| **Gradiente brand** | `linear-gradient(135deg, [colore1], [colore2])` |
| **Colore CTA intermedio** | `[DA DEFINIRE]` — tinta chiara per sezioni di stacco |
| **Font heading** | `[DA DEFINIRE]` |
| **Font sans** | `[DA DEFINIRE]` |
...
1. **Hero homepage**: ritratto professionale (formato verticale, alta qualità)
2. **Chi Sono**: foto in studio o in camice
3. **Prima e Dopo**: set di foto cliniche (prima/dopo trattamenti)
4. **Favicon**: iniziali "AF" su sfondo brand (generato dinamicamente)
